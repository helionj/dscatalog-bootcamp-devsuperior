...
describe('Pagination tests', () => {
  ...
  test('should render Pagination', () => {
    ...
    expect(page1).toHaveClass("paginate-link-active")
    expect(page2).toBeInTheDocument();
    expect(page2).not.toHaveClass("paginate-link-active")
    expect(page3).toBeInTheDocument();
    expect(page3).not.toHaveClass("paginate-link-active")
  ...
  test('previous next arrow should call onChange ', () => {
    ...
    render(
      <Pagination pageCount={pageCount} range={range} onChange={onChange} forcePage={2}/>
    )
